...
if (manifest.version !== '2.2.0') throw new Error('v1.9 manifest missing');
...
if (!content.includes("JOBCLAW_CONTENT_BUILD = '2.2.0-auto-recovery.1'")) throw new Error('content startup build missing');
