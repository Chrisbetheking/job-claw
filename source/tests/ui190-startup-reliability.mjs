...
if (manifest.version !== '2.1.0') throw new Error('v1.9 manifest missing');
...
if (!content.includes("JOBCLAW_CONTENT_BUILD = '2.1.0-ai-pause.2'")) throw new Error('content startup build missing');
