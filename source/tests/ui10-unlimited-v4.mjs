...
if (manifest.version !== '2.2.0') throw new Error(`版本错误：${manifest.version}`);
for (const token of ['discoveryLimit: 150', 'dailyTarget: 150', "batchStrategy: 'safe-mass'", "massApplyAnalysis: 'auto-ai'", 'maxPerCompanyPerDay: 3', 'maxConsecutiveFailures: 6']) {
